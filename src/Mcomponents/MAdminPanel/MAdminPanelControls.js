        ...
        return(
            <React.Fragment>
                <Container maxWidth='sm' className={classes.container}>
                    ...
                    <TextField value={this.state.name} onChange={this.onInputChange} name='name' id='focus' label="Name" variant="outlined" className={classes.textField} autoFocus/>
                    <TextField value={this.state.price} inputProps={inputProps} onChange={this.onInputChange} name='price' type='number' label="Price" variant="outlined" className={classes.textField}/>
                    <TextField value={this.state.discountedPrice} inputProps={inputProps} onChange={this.onInputChange} name='discountedPrice' type='number' label="Discounted Price" variant="outlined" className={classes.textField}/>
                    <Button disabled={this.state.isInputEmpty} variant='contained' color='primary' className={classes.addButton} onClick={this.clearInputs}>ADD</Button>
                </Container>
